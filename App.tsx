  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#3c4a3e]/60 flex items-center justify-center p-4 backdrop-blur-sm">
       <div className="bg-white rounded-3xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          {/* Navigation */}
          <div className="flex border-b border-stone-200 bg-white px-2 md:px-4 overflow-x-auto" style={{scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch', msOverflowStyle: 'none'}} onScroll={(e) => { (e.target as HTMLDivElement).style.setProperty('--webkit-scrollbar-display', 'none'); }}>
            <style>{`
